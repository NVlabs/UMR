...
class alexnet(torch.nn.Module):
    def __init__(self, requires_grad=False, pretrained=False, dgx=False):
        ...
        if(dgx):
            ...
            model.load_state_dict(torch.load('/workspace/models/alexnet-owt-4df8aa71.pth'))
        else:
            model = models.alexnet(pretrained=True)
        #model.load_state_dict(torch.load('/media/unsup-mesh/models/alexnet-owt-4df8aa71.pth'))
